...
ctx.clear();
ctx.gl.drawArrays(ctx.gl.TRIANGLES, 0, points.length);
...
toolbar
    .selectAll(".item")
    .data([
        { name: "点", value: ctx.gl.POINTS },
        { name: "线段", value: ctx.gl.LINES },
        { name: "线条", value: ctx.gl.LINE_STRIP },
        { name: "回路", value: ctx.gl.LINE_LOOP },
        { name: "三角形", value: ctx.gl.TRIANGLES },
